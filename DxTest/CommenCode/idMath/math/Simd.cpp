...
idSIMDProcessor	*	processor = (idSIMDProcessor*)0;			// pointer to SIMD processor
idSIMDProcessor *	generic = (idSIMDProcessor *)0;				// pointer to generic SIMD implementation
idSIMDProcessor *	SIMDProcessor = (idSIMDProcessor *	)0;
...
void idSIMD::Shutdown( void ) {
	...
	delete generic;
	generic = (idSIMDProcessor*)0;
	processor = (idSIMDProcessor*)0;
	SIMDProcessor = (idSIMDProcessor*)0;
...
//
	...
	p_simd = (idSIMDProcessor*)0;
	p_generic = (idSIMDProcessor*)0;
